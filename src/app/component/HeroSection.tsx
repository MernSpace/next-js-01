...
bg-gradient-to-b mfrom-neutral-50  text-white'>Master the art of music</h1>
                <p className='mt-4 font-normal text-base md:text-lg
•text-neutral-300 max-w-lg mx-auto text-white'>Dive into our comprehensive music courses and
